...
class Comment {
    ...
    public function create() {
        ...
        if($numResponses > 0) { //viewReplies is created if answers to the comment exist
    ...
    public function getNumberOfReplies() { //checks if answers to a comment exist
    ...
    function time_elapsed_string($datetime, $full = false) { //php timestamp ago function from stackoverflow
        $now = new DateTime;
    ...
    public function getLikes() {
        ...
        $data = $query->fetch(PDO::FETCH_ASSOC); //assoc. array
        $numLikes = $data["count"];
        ...
        return $numLikes - $numDislikes; //we are getting all the likes and dislikes from the tables, to calculate the number of likes
    }
