...
class VideoInfoSection {
    ...
    private function createSecondaryInfo() {
        ...
        $profileButton = ButtonProvider::createUserProfileButton($this->con, $uploadedBy); //static function doesnt need instance of the class
        ...
        if($uploadedBy == $this->userLoggedInObj->getUsername()) {
            ...
            //action button shows subscribe/ edit button
        }
