...
class VideoDetailsFormProvider {
    ...
    public function __construct($con) {
        $this->con = $con; //setting the variable as the value (passed in from upload.php)
    }
    ...
    public function createUploadForm() {
        ...
        return "<form action='processing.php' method='POST' enctype='multipart/form-data'>  
                    ...
                    $uploadButton
                                                            ...
                                                            // enctype='multipart/form-data' allows uploading files
    }
    ...
    private function createCategoriesInput($value) {
        ...
        while($row = $query->fetch(PDO::FETCH_ASSOC)) { //getting the data from the mysql table and putting them out in an array
            $id = $row["id"];
            $name = $row["name"];
